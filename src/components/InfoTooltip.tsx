export default function InfoTooltip({ content }: { content: string }) {
  return (
    <span className="relative group inline-flex items-center ml-1 align-middle">
      <span className="cursor-help w-4 h-4 rounded-full border border-gray-400 text-gray-400 hover:border-[#0071e3] hover:text-[#0071e3] text-[10px] font-bold inline-flex items-center justify-center select-none transition-colors">
        i
      </span>
